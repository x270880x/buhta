...
**Правка по просьбе пользователя:** участку `2320355400:12:001:0042` (Моршнев С.А., 0.0773 га, З.Берег)
проставлен `egrn:"да"` — визуально голубой, как оформленные. Документов ЕГРН по нему НЕТ, кадастра РФ нет;
пометка сделана по прямому указанию 29.07.2026.
